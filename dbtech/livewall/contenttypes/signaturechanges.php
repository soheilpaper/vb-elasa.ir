<?php
class LiveWall_ContentType_signaturechanges extends LiveWall_ContentType_Core
{
	/**
	...
	*/	
	public function constructPhrase($info)
	{
		...
		return construct_phrase($vbphrase['dbtech_livewall_x_changed_their_signature'], 
