<?php
class vBActivity_Type_shout extends vBActivity_Type_Core
{
	/**
	...
	*/	
	public function action($user)
	{
		...
		// We made it!
		return ($this->registry->products['dbtech_vbshout']);
	}
	...
	*/	
	public function check_criteria($conditionid, &$userinfo)
	{
		...
		if (!isset($userinfo['dbtech_vbshout_shouts_lifetime']))
		{
			// We need more info
		...
		// We had this info
		$userinfo[$typename] = $userinfo['dbtech_vbshout_shouts_lifetime'];
