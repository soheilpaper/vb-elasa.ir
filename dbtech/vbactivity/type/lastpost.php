<?php
class vBActivity_Type_lastpost extends vBActivity_Type_Core
{
	/**
	...
	*/	
	public function recalculate_points($user)
	{
		...
		// Set the multiplier
		$multiplier = floor((TIMENOW - $user['lastpost']) / 86400);
	...
	*/	
	public function check_criteria($conditionid, &$userinfo)
	{
		...
		// We had this info
		$userinfo[$typename] = floor((TIMENOW - $userinfo['lastpost']) / 86400);
