<?php
class vBActivity_Type_tagsreceived extends vBActivity_Type_Core
{
	/**
	...
	*/	
	public function recalculate_points($user)
	{
		...
		$hook_query_where 	= " AND taggedid = " . $user['userid'];
		$multiplier 		= 1;
	...
	*/	
	public function check_criteria($conditionid, &$userinfo)
	{
		...
		if (!isset($userinfo['dbtech_usertag_tags']))
		{
			// We need more info
		...
		// We had this info
		$userinfo[$typename] = $userinfo['dbtech_usertag_tags'];
