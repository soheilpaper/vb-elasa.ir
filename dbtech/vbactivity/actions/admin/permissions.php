...
if ($_REQUEST['action'] == 'permissions' OR empty($_REQUEST['action']))
{
	...
	$includegroups = array('dbtech_vbactivitypermissions');
	...
	print_cp_header($vbphrase['dbtech_vbactivity_permissions']);
	echo '<style type="text/css">dfn { display:none; }</style>';
	print_form_header('vbactivity', 'permissions');
	construct_hidden_code('action', 'update');
	print_table_header($vbphrase['dbtech_vbactivity_permissions'], count($headings));
...
if ($_POST['action'] == 'update')
{
	...
	define('CP_REDIRECT', 'vbactivity.php?do=permissions');
	print_stop_message('dbtech_vbactivity_x_y', $vbphrase['permissions'], $vbphrase['dbtech_vbactivity_edited']);
}
