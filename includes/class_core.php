...
define('FILE_VERSION', '4.2.2'); // this should match installsteps.php
define('SIMPLE_VERSION', '422'); // see vB_Datastore::check_options()
...
*
* @package	vBulletin
* @version	$Revision: 77921 $
* @date		$Date: 2013-10-04 16:00:27 -0700 (Fri, 04 Oct 2013) $
*/
class vB_Database
{
	/**
