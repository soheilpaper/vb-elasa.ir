...
*
* @package	vBulletin
* @version	$Revision: 77659 $
* @date		$Date: 2013-09-20 09:14:01 -0700 (Fri, 20 Sep 2013) $
*/
class vB_Bitfield_Builder
{
	...
	*/
	public static function fetch_permission_group($permgroup)
	{
		$output = array();
		$obj =& vB_Bitfield_Builder::init();
